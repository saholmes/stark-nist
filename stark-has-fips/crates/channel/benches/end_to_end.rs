...
fn bench_e2e_mf_fri(c: &mut Criterion) {
    ...
    for &(label, schedule) in presets {
        ...
        for &k in &ks {
            ...
            // BEFORE (synthetic random — full-rank, not degree-bounded):
            //
            ...
            // AFTER (real trace — degree-bounded polynomials, rate 1/4):
            //use crate::trace_import::real_trace_inputs;

            let trace = real_trace_inputs(n0, 4);   // blowup factor 4
